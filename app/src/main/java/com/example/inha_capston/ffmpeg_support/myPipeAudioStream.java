...
public class myPipeAudioStream {

    //private final static Logger LOG = Logger.getLogger(PipedAudioStream.class.getName());

    private final String resource;
   // private static myPipeDecoder pipeDecoder = new myPipeDecoder();

//    public static void setDecoder(myPipeDecoder decoder){
//        pipeDecoder = decoder;
//    }

    private final myPipeDecoder decoder;
    public myPipeAudioStream(Context context, String resource){
        this.resource = AudioResourceUtils.sanitizeResource(resource);
        decoder = new myPipeDecoder(context);
    }
